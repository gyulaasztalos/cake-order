...
HU: dict[str, str] = {
    ...
    "form.sponge": "Piskóta",
    "form.sponge_hint": "ha már van ötleted",
    "form.sponge_ph": "Válassz piskótát",
    "form.sponge.kakaos": "Kakaós",
    "form.sponge.fekete_kakaos": "Fekete kakaós",
    "form.sponge.makos": "Mákos",
    "form.sponge.pisztacias": "Pisztáciás",
    "form.sponge.dios": "Diós",
    "form.sponge.mogyoros": "Mogyorós",
    "form.sponge.alap_vanilias": "Alap vaníliás",
    "form.sponge.egyeb": "Egyéb",
    "form.flavor": "Íz",
    ...
    "email.chef.open_draft": "Vázlat megnyitása és árazása",
...
EN: dict[str, str] = {
    ...
    "form.sponge": "Sponge",
    "form.sponge_hint": "if you already have an idea",
    "form.sponge_ph": "Choose a sponge",
    "form.sponge.kakaos": "Cocoa",
    "form.sponge.fekete_kakaos": "Black cocoa",
    "form.sponge.makos": "Poppy seed",
    "form.sponge.pisztacias": "Pistachio",
    "form.sponge.dios": "Walnut",
    "form.sponge.mogyoros": "Hazelnut",
    "form.sponge.alap_vanilias": "Classic vanilla",
    "form.sponge.egyeb": "Other",
    "form.flavor": "Flavour",
...
DE: dict[str, str] = {
    ...
    "form.sponge": "Biskuit",
    "form.sponge_hint": "falls Sie schon eine Idee haben",
    "form.sponge_ph": "Biskuit wählen",
    "form.sponge.kakaos": "Kakao",
    "form.sponge.fekete_kakaos": "Schwarzer Kakao",
    "form.sponge.makos": "Mohn",
    "form.sponge.pisztacias": "Pistazie",
    "form.sponge.dios": "Walnuss",
    "form.sponge.mogyoros": "Haselnuss",
    "form.sponge.alap_vanilias": "Klassisch Vanille",
    "form.sponge.egyeb": "Sonstiges",
    ...
    "email.chef.open_draft": "Entwurf öffnen und kalkulieren",
    "email.field.name": "Name",
    "email.field.email": "E-Mail",
    "email.field.phone": "Telefon",
    "email.field.due_date": "Datum des Anlasses",
    "email.field.cake_type": "Tortentyp",
    "email.field.sponge": "Biskuit",
...
# Available sponge (piskóta) bases (owner's list, 2026-07-26). Slugs stored in
# ORDERS.sponge; display names come from the catalogs, like FLAVORS.
SPONGES = (
    "kakaos",
    "fekete_kakaos",
    "makos",
